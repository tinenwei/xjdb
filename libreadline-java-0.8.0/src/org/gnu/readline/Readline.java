...
public class Readline {
  ...
  */
  ...
  private static BindKeyHandler iKeyHandler = null;
  ...
  */
  ...
  public static boolean parseAndBind(String line) {
    ...
    public static boolean BindKey(int key ) {
    if (iLib == ReadlineLibrary.GnuReadline)
      return BindKeyImpl(key);
    else if (iThrowException)
      throw new UnsupportedOperationException();
    else
      return true;
  ...
  */
  ...
  public static void setBindKeyHandler(BindKeyHandler kh) {
    iKeyHandler = kh;
    if (iLib == ReadlineLibrary.GnuReadline ||
                                             iLib == ReadlineLibrary.Editline) {
      setBindKeyImpl(iKeyHandler);
    } else if (iThrowException)
      throw new UnsupportedOperationException();
  }
  ...
  */
  ...
  private native static boolean BindKeyImpl(int key);
  ...
  */
  ...
  private native static void setBindKeyImpl(BindKeyHandler rlc);
